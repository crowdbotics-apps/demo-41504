"""
Django settings for demo_41504 project.
...
WSGI_APPLICATION = 'demo_41504.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_41504 API",
    "DESCRIPTION": "API documentation for demo_41504 App",
    "VERSION": "v1",
}
